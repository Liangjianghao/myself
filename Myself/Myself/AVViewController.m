...
@property(nonatomic,strong)NSString *imgTypeStr;
...
-(void)ceateUI
{
    ...
    //拍照按钮
    _shutterBtn=[[UIButton alloc]initWithFrame:CGRectMake(100, kHeight-60, kWidth-200, 40)];
    
    NSLog(@"_shutterBtn%f %f %f %f ",_shutterBtn.frame.origin.x,_shutterBtn.frame.origin.y,_shutterBtn.frame.size.width,_shutterBtn.frame.size.height);
    ...
    segmentCtr.frame=CGRectMake(10, kHeight-60, kWidth-20, 40);
...
-(void)segChange:(UISegmentedControl *)seg
{
    ...
    _imgTypeStr=[NSString stringWithFormat:@"%ld",(long)index];
...
-(void)showCapturedImage:(UIImage *)image
{
    ...
    UIButton *cancelBtn=[[UIButton alloc]initWithFrame:CGRectMake(xpos,kHeight- ypos, 60, 40)];
    ...
    UIButton *saveBtn=[[UIButton alloc]initWithFrame:CGRectMake(kWidth-80, kHeight-ypos, 60, 40)];
